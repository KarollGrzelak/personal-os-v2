...
async function checkIndex() {
  ...
  if (bodyOpenIndex < 0
    ...
    fail('skrypty core.js, today.js, training.js, learning.js, school.js, availability.js, english.js, plan-day.js, backup.js i app.js muszą być sąsiadującymi ostatnimi elementami przed zamknięciem body');
  }
  ...
  if (planDaySource.length === 0) fail('src/plan-day.js jest pusty');
  ...
  try {
    ...
    new vm.Script(planDaySource, { filename: 'src/plan-day.js' });
